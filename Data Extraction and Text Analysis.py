...
# # step2: downloading "punkt" and "Stopword"
...
# # step3: loading 'list.xlxs' into DataFrame

# In[4]:


df = pd.read_excel("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\cik_list.xlsx")
df.head()


# step4: making proper links
...
# # step6: Identing and Finding total lengtyh

# In[10]:


with open("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\StopWords_Generic.txt",'r') as f:
    stop_words = f.read()
...
# # step7: started analysis according to the required objective¶
# 
...
master_dic = pd.read_excel("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\LoughranMcDonald_MasterDictionary_2018.xlsx")
master_dic.head()
...
uncertainity = pd.read_excel("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\uncertainty_dictionary.xlsx")
uncertainity_words = list(uncertainity['Word'])

constraining = pd.read_excel("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\constraining_dictionary.xlsx")
...
# # step8: saving to excel

# In[23]:


df.to_excel("C:\\Users\\91912\\Desktop\\CSV2\\blackclover\\Output.xlsx")
